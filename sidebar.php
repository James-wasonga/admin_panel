...
<div class="side-header">
    <img src="./assets/images/profilePhoto.jpg" width="120" height="120" alt="Swiss Collection"> 
...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="#sizes"   onclick="showSizes()" ><i class="fa fa-th"></i> Quantity</a>
    ...
    <a href="upload.php"><i class="fa fa-list"></i>Services</a>
    <a href="#orders" onclick="showOrders()"><i class="fa fa-list"></i> Orders</a>
</br>
</br>

<a href="./logout.php"><i class="fa fa-list"></i> logout</a>
